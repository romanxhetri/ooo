...
export const FlameIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        ...
        <path d="M10 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 10a8 8 0 1116 0 8 8 0 01-16 0z" />
    </svg>
);

export const VegetarianIcon: React.FC<{ className?: string }> = ({ className }) => (
    <span className={className} title="Vegetarian">V</span>
);
export const VeganIcon: React.FC<{ className?: string }> = ({ className }) => (
    <span className={className} title="Vegan">VG</span>
);
export const GlutenFreeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <span className={className} title="Gluten-Free">GF</span>
);
